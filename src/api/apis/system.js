...
export default {
  ...
  /* global-weak-pwd end */
    ...
    // 系统信息-授权信息
    fetchAuthCertGetLicense (data) {
        return axios.get(systemUrls.authCertGetLicense, data)
    },
    // 系统信息-申请延期
    fetchAuthCertApply (data) {
        return axios.post(systemUrls.authCertApply, data)
    },
    // 系统信息-获取最后联系人信息
    fetchAuthCertGetLastApplyInfo (data) {
        return axios.get(systemUrls.authCertGetLastApplyInfo, data)
    },
    // 系统信息-获取授权配置
    fetchAuthCertSysConfig (data) {
        return axios.get(systemUrls.authCertSysConfig, data)
    }
